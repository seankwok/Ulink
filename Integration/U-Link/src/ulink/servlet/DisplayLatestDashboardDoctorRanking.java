...
public class DisplayLatestDashboardDoctorRanking extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayLatestDashboardDoctorRanking() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<RankingDoctor> list = connection.retrieveAllRankingDoctorDashBoard(myDate.toString());
		Gson gson = new Gson();
